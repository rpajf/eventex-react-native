...
const Profile: React.FC = () => {
  const images = [
    {title: 'img1', key: '1', src: require('../../assets/img/festival-green.jpg')},
    {title: 'img2', key: '2', src: require('../../assets/img/tech2.jpg')},
    {title: 'img3', key: '3', src: require('../../assets/img/music-event.png')},
