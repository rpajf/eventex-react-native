    ...
    <Container>
      ...
      <UsersList>
        <ScrollView horizontal={false}>
          <UserRow>
            <UserStatus />
            <Small style={{color: '#ced0da', fontSize: 15, lineHeight: 16}}>Diego</Small>
          </UserRow>
          <UserRow>
            <UserStatus />
            <Small style={{color: '#ced0da', fontSize: 15, lineHeight: 16}}>Raphael</Small>
          </UserRow>
          <UserRow>
            <UserStatus />
          ...
          <UserRow>
            ...
            <Small style={{color: '#ced0da', fontSize: 15, lineHeight: 16}}>Nagib</Small>
          </UserRow>
          <UserRow>
            <UserStatus />
            <Small style={{color: '#ced0da', fontSize: 15, lineHeight: 16}}>Carlos</Small>
          </UserRow>
          <UserRow>
            <UserStatus />
            <Small style={{color: '#ced0da', fontSize: 15, lineHeight: 16}}>Carlos</Small>
