...
import {AuthNavigatorParamsList, BottomNavigatorParamsList, RootNavigatorParamsList} from '../../types';
...
interface SignInFormData {
  ...
  phone: number;
  bornDate: string;
  navigation: BottomTabNavigationProp<AuthNavigatorParamsList, 'Auth'>;
}
